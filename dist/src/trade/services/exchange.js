...
exports.BuyExchangeService = exports.ExchangeService = void 0;
...
const ExchangeService = (selling, buying, amount) => {
...
const BuyExchangeService = (selling, buying, amount) => {
    const sellingCoin = coins.filter(item => item.coin == selling)[0]; // satılmak istenen coin
    const buyingCoin = coins.filter(item => item.coin == buying)[0]; // alınmak istenen coin
...
exports.BuyExchangeService = BuyExchangeService;
